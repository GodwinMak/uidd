...
const RegContent = () => {
  return (
    <div className='reg_content'>
      <div className='reg_paragraph'>
          <h2 style={{textAlign: "center"}}>Registration Form</h2>
          <p style={{textAlign: "center"}}>
              Dear Student, thank you for your interest in our Society.
              Please complete the information in this form to help the Society analyze your request and make an informed decision.
              Kindly note that the information you provide will solely be used for analysis by the Society, and will not be used for matters unrelated to the Society.
          </p>
        </div>
